export default function DividerMoney() {
  return (
    <section className="relative bg-navy-950 overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_70%_80%_at_50%_50%,rgba(19,47,78,0.42)_0%,rgba(7,23,43,0)_72%)]" />
      <div className="absolute left-1/2 top-1/2 h-px w-[min(48rem,62vw)] -translate-x-1/2 bg-gradient-to-r from-transparent via-gold-500/16 to-transparent" />

      <div className="relative max-w-6xl mx-auto px-5 sm:px-8 py-9 sm:py-11 lg:py-12 text-center">
